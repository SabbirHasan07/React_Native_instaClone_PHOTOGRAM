...
import ProfileContent from "../ScreenComponents/ProfileContent"
                ...
                style={{
                    ...
                    >
                        <View style={{
                            ...
                            <Image source={require('../../../images/sabbir_br.jpg')} style={{
                                width:30,
                                height:30,
                                borderRadius:100
                            }}/>
                        ...
                        <View style={{
                            ...
                            <Ionic name="trash-outline" style={{fontSize:26}}/>
                            <Ionic name="bookmark-outline" style={{fontSize:26}}/>
